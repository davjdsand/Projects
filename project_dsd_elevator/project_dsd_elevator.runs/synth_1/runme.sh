...
HD_PWD='C:/Users/sandd/Desktop/Vivado/project_dsd_elevator/project_dsd_elevator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ElevatorController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ElevatorController.tcl
