...
HD_PWD='C:/Users/sandd/Desktop/Vivado/project_dsd_elevator/project_dsd_elevator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ElevatorController.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ElevatorController.tcl -notrace
